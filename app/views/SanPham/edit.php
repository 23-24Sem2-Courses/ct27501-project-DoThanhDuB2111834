...
<?php $this->start("page") ?>
<form class="row mt-3" id="form-themSP" method="POST" action="/SanPham/update/<?= $sanPham->id ?>" enctype="multipart/form-data">
    <fieldset class="col-6 offset-3 border border-secondary py-2 rounded">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="editForm-tenSP" name="tenSPInput" class="form-control" value="<?= isset($olds['tensp']) ? $olds['tensp'] :
        ...
        <div class="mb-3 row">
            ...
            <input type="number" id="editForm-giaSP" name="giaSPInput" class="form-control" required value="<?= isset($olds['giasp']) ? $olds['giasp'] :
