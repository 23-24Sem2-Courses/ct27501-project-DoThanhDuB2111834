...
<form class="row mt-3" id="form-themSP" method="POST" enctype="multipart/form-data">
        <fieldset class="col-6 offset-3 border border-secondary py-2 rounded">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="editForm-tenSP" name="tenSPInput" class="form-control"
                    value="<?php isset($sanPham) ? $this->e($sanPham->tensp) : '' ?>"
                    placeholder="Nhập vào tên sản phẩm">
            </div>
            <div class="mb-3 row">
                <label for="editForm-giaSP" class="form-label col">Giá sản phẩm</label>
                <input type="number" id="editForm-giaSP" name="giaSPInput" class="form-control" required
                    value="<?= isset($sanPham) ? $this->e($sanPham->giasp) : '' ?>" aria-describedby="inputGroupPrepend" placeholder="Nhập vào giá sản phẩm">
            ...
            <div class="input-group mb-3">
                ...
                <textarea class="form-control" name="motaSPInput" aria-label="With textarea" 
                        value=" <?= isset($sanPham) ? $this->e($sanPham->motasp) : '' ?>"></textarea>
            </div>
            <div class="input-group mb-3">
                <label class="input-group-text" for="editForm-imgSP">Upload</label>
                <input type="file" class="form-control" name="imgSPInput" id="editForm-imgSP"
                        value=" <?= isset($sanPham) ? $this->e($sanPham->imgsp.'JPG') : '' ?>">
